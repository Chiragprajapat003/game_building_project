...
// const startBtn =  document.getElementById('startstn');
// const restartBtn =  document.getElementById('restartBtn');
// const resetBtn = document.getElementById('resetstn');
...
//     const inner = document.createElement('dic')
...
function shuffle(num2){     // 
    ...
    for(let i = num2.length-1;i>0;i--){      // this is for loop is use for random number in the card in any index and store in the num2 array 
        var j = Math.floor(Math.random()*(i+1)); // 
        console.log(j);
        [num2[i] , num2[j]] = [num2[j] , num2[i]];   // this store value of i into j and j store into i
    }
    return num2;
}
